    ...
    return (
        <>
            ...
            <h2 className="font-black text-3xl text-center mt-10">Editar Perfil</h2>
                <p className="text-xl mt-5 mb-5 text-center">Modifica tu {''} <span className="text-indigo-600 font-bold">informacion aqui</span></p>
                ...
                <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
                    ...
                    >
                        ...
                        <input type="submit"
                            ...
                            className="bg-indigo-700 hover:bg-indigo-900 px-10 py-3 font-bold text-white rounded-lg uppercase w-full mt-5"
                        />
                    </form>
                </div>
            </div>
